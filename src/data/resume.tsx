  ...
  projects: [
    {
      ...
      links: [
        { type: "Website", href: "http://44.197.196.65/login", icon: Icons.globe },
        { type: "Source", href: "https://github.com/CapedCrusader03/K-Docs", icon: Icons.github },
      ],
      image: "",
      video: "",
    },
    {
      ...
      links: [
        { type: "Website", href: "https://github.com/CapedCrusader03/Code-Reviewer", icon: Icons.globe },
        { type: "Source", href: "https://github.com/CapedCrusader03/Code-Reviewer", icon: Icons.github },
      ],
      image: "",
      video: "",
    },
    {
      ...
      links: [
        { type: "Website", href: "https://github.com/CapedCrusader03", icon: Icons.globe },
        { type: "Source", href: "https://github.com/CapedCrusader03", icon: Icons.github },
      ],
      image: "",
      video: "",
    },
    {
      title: "Distributed Text Chat Application",
      href: "https://github.com/CapedCrusader03/distributed-chat",
      dates: "2022 - 2023",
      active: true,
      description: "<ul class='list-disc list-inside space-y-1 text-sm leading-relaxed'><li>Engineered a centralized server architecture in C to manage global state for multiple clients using TCP sockets and I/O multiplexing (select())</li><li>Implemented a store-and-forward messaging protocol to buffer offline data and automatically deliver it upon user login, ensuring message persistence</li><li>Developed application-layer features including unicast, server-assisted broadcast, and dynamic client blocking/unblocking to filter network traffic</li><li>Designed a custom Command Line Interface (CLI) to handle simultaneous user commands (stdin) and network packet processing without blocking system resources</li></ul>",
      technologies: ["C", "TCP/IP", "Linux", "Sockets", "I/O Multiplexing", "System Programming"],
      links: [
        { type: "Source", href: "https://github.com/CapedCrusader03/distributed-chat", icon: Icons.github },
      ],
      image: "",
      video: "",
    },
