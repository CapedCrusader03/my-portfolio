  ...
  work: [
    {
      ...
      description: "<ul class='list-disc list-inside space-y-1 text-sm leading-relaxed'><li>Engineered a migration pipeline in Java, Spring Boot, leveraging Debezium for CDC and Apache Kafka to stream updates from sources (Oracle Redo Logs, MySQL Binlogs, PostgreSQL WALs) to diverse targets (PostgreSQL, MSSQL, Snowflake, BigQuery, Redshift)</li><li>Implemented Dead Letter Queues to isolate and replay less than 0.5% of failed events and drifted data, preventing pipeline blockage during complex schema conversions</li><li>Architected a real-time validation software utilizing LSN-based watermarking to monitor Eventual Consistency and Replication Lag, ensuring 99.999% data integrity across cross-vendor ecosystems</li><li>Spearheaded the transition to Microservices, implementing an API Gateway with granular Token Bucket rate limiting policies to prevent Noisy Neighbor issues and DDoS attacks</li><li>Optimized the Data Validation module by combining queries via Apache Drill with CDC stream analysis, verifying records across 10+ database dialects and reducing validation time by ~31%</li><li>Partnered with a Principal Architect to develop a predictive DB Selection Framework from scratch using Python and FastAPI; the tool analyzed I/O patterns and storage growth to identify optimal migration targets, projecting cloud infrastructure savings of ~25%</li><li>Secured stakeholder interest by demonstrating this framework to 10+ potential clients including ANZ Bank, Mazda, Bank of America, Charles Schwab and Ford</li><li>Wrote clean, maintainable, and testable code following CI/CD best practices using Git and Maven while mentoring and conducting code reviews for a team of 2 junior developers</li></ul>",
    },
  ],
  projects: [
    {
